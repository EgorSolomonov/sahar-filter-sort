	...
	?>
		<div class="bx_catalog_item"><a class="bx_catalog_item_container" href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" id="<? echo $strMainID; ?>">
				<div id="<? echo $arItemIDs['PICT']; ?>" class="bx_catalog_item_images" style="background-image: url('<? echo $arItem['PREVIEW_PICTURE']['SRC']; ?>')">
					<? // Favorite 
					?>
					<div class="section_favorite" data-item="<?= $arItem["ID"] ?>">
						<img src="<?= SITE_TEMPLATE_PATH ?>/images/Vector.svg" alt="favorite_img">
					</div>
					<div class="stickers">
				...
				<div class="bx_catalog_item_info">
					<div class="bx_catalog_item_title"><? echo $productTitle; ?></div>
					<div class="bx_catalog_item_price">
						<div id="<? echo $arItemIDs['PRICE']; ?>" class="bx_price">
							<? if (($arItem['PROPERTIES']["OLD_PRICE"]["VALUE"]) && ($arItem['MIN_PRICE']['VALUE'] != $arItem['PROPERTIES']["OLD_PRICE"]["VALUE"]) && ($arResult['PROPERTIES']["OLD_PRICE"]["VALUE"] > $arResult['MIN_PRICE']["VALUE"])) : ?>
