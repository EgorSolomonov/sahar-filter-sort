...
?><div class="bx_item_detail" id="<? echo $arItemIDs['ID']; ?>">
	...
	<div class="bx_item_container">
		<div class="bx_lt">
			...
			<div class="bx_items_wrapper" id="<? echo $arItemIDs['BIG_SLIDER_ID']; ?>">
				<? foreach ($arResult['MORE_PHOTO'] as $key => &$arOnePhoto) : ?>
					<a class="bx_item_wrapper" data-fancybox="group-1" href="<? echo $arOnePhoto['SRC']; ?>">
						<? if ($key === 0) : ?>
							<div class="stickers">
								<? if ($arResult['PROPERTIES']["NOVINKA"]["VALUE"] == 'Да') : ?>
									<div class="sticker_novinka"></div>
						...
						<img class="bx_item_img" src="<? echo $arOnePhoto['SRC']; ?>" alt="" />
					</a>
				<? endforeach; ?>
			</div>
			...
			<div class="bx_rt_wrapper">
				...
				<div class="bx_item_info">
					...
					<div class="item_price">
						...
						?>
						<div class="item_current_price" id="<? echo $arItemIDs['PRICE']; ?>" style="<? if ($arResult['PROPERTIES']["OLD_PRICE"]["VALUE"]) : ?>color: #FF3535;<? endif; ?>"><? echo $minPrice['PRINT_DISCOUNT_VALUE']; ?></div>
						<?
				...
				<div class="bx_item_buttons">
					...
					<!-- <pre>
						...
						var_dump($arElements);
						$key = array_search($arElements[0], $arElements);
						var_dump($key);
					...
					?>
						...
						<div class="item_buttons vam">
							...
							<div class="favorite_wrapper">
								...
								<div class="section_favorite" data-item="<?= $arResult["ID"] ?>">
				...
				<? // Блок фиксированной кнопки и размеров при скролле 
				?>
				...
				<? // Блок фиксированной кнопки и размеров при скролле конец 
				?>
				...
				<? if ($arResult["ELEMENTS"]) : ?>
					<div class="similar_products">
						...
						<div class="item-wrapper">
							<? for ($i = 0; $i <= 5; $i++) : ?>
								<? if ($arResult["~ID"] !== $arResult["ELEMENTS"][$i]['ID']) : ?>
									<a href="<?= $arResult["ELEMENTS"][$i]['DETAIL_PAGE_URL'] ?>">
										<div class="item">
											<img src="<?= CFile::GetPath($arResult["ELEMENTS"][$i]['PREVIEW_PICTURE']) ?>" alt="item_img">
											<p><?= $arResult["ELEMENTS"][$i]['NAME'] ?></p>
											<span><?= $arResult["ELEMENTS"][$i]['PRICE'] ?> ₽</span>
										</div>
									</a>
								<? endif; ?>
							<? endfor; ?>
