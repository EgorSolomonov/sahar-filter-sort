...
$tpl  = "";
if($request->get('quickview') == "Y")
{
    $APPLICATION->RestartBuffer();
    $tpl = "quick_view";
    ?>
    <div class="quick-view-popup">
    <a class="popup-close material-icons" href="#" onclick="quickViewClose(); return false;">close</a>
...
$ElementID = $APPLICATION->IncludeComponent(
	...
	array(
		...
		"GIFTS_MAIN_PRODUCT_DETAIL_BLOCK_TITLE" => $arParams['GIFTS_MAIN_PRODUCT_DETAIL_BLOCK_TITLE'],
                //"CURRENT_OFFER" => intval($_REQUEST["pid"]) > 0 ? intval($_REQUEST["pid"]) : 0
	),
	$component
);
if($request->get('quickview') == "Y")
