...
<div class="no-gutters">
	...
	<? endif ?>
	<? // тут скрыл фильтр, перенес в другое место
	?>
	...
	<div class="<?= (($isFilter || $isSidebar) ? "col-md-9 col-sm-8" : "col-xs-12") ?> krayt_content_block krayt_content_block_active">
		<div class="row">
			...
			<div class="col-xs-12" style="padding: 0;">
				<div class="title-filter-sort_wrapper">
					...
					<div class="filter-sort_wrapper">
						...
						<? include($_SERVER["DOCUMENT_ROOT"] . "/include/catalog_sortable.php"); //настройки кастомной сортировки 
						?>
					</div>
				</div>
				<?
			...
			<!-- <div class="catalog_filter_box">
					...
					<a href="<?= ($section_sort != "price_asc") ? $APPLICATION->GetCurPageParam("sort=price_asc", array("sort")) : $APPLICATION->GetCurPageParam("", array("sort")); ?>" <? if ($section_sort == "price_asc") : ?>class="active" <? endif; ?>><?= GetMessage('FILTER_PRICE_ASC'); ?></a>
			...
			?>
			<? //debug($arParams["ELEMENT_SORT_ORDER"]);
			?>
			<? //debug($arParams["PRICE_CODE"]);
			?>
